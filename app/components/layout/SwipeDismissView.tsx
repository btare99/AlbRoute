    ...
    <div style={containerStyle} className={className}>
      ...
      <div
        ...
        style={{
          ...
          position: 'relative',
          zIndex: 3,
          background: isFixed ? 'rgba(10, 15, 26, 0.72)' : 'transparent',
          backdropFilter: isFixed ? 'blur(30px) saturate(190%)' : 'none',
          WebkitBackdropFilter: isFixed ? 'blur(30px) saturate(190%)' : 'none',
          borderLeft: isFixed && direction === 'horizontal' ? '1px solid rgba(255, 255, 255, 0.08)' : 'none',
          borderTop: isFixed && direction === 'vertical' ? '1px solid rgba(255, 255, 255, 0.08)' : 'none',
          transform: transform,
          transition: isSwiping ? 'none' : 'transform 0.3s cubic-bezier(0.25, 1, 0.5, 1)',
